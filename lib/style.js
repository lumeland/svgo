import { csstree, is, selectAll, specificity, stable } from "../deps.js";

import * as svgoCssSelectAdapter from "./svgo/css-select-adapter.js";
...
export function computeStyle(node) {
  ...
  for (const styleNode of styleNodes) {
    const dynamic = styleNode.attributes.media != null &&
