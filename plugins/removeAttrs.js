...
export function fn(item, params) {
  ...
  if (item.type === "element") {
    var elemSeparator = typeof params.elemSeparator == "string"
      ? params.elemSeparator
      : DEFAULT_SEPARATOR;
    var preserveCurrentColor = typeof params.preserveCurrentColor == "boolean"
    ...
    patterns.forEach(function (pattern) {
      ...
      if (pattern[0].test(item.name)) {
        ...
        for (const [name, value] of Object.entries(item.attributes)) {
          var isFillCurrentColor = preserveCurrentColor && name == "fill" &&
            value == "currentColor";
          var isStrokeCurrentColor = preserveCurrentColor && name == "stroke" &&
            value == "currentColor";
