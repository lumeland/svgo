  ...
  !function (e, t) {
    ...
    (function () {
      ...
      function t(e, t, n) {
        var i;
        return null !== r
          ? (i = r, r = r.cursor, i.prev = t, i.next = n, i.cursor = e.cursor)
      ...
      function s(e, t) {
        ...
        var r = e.source.split(/\r\n?|\n|\f/),
          ...
          c = 0;
        (a += ("    ".length - 1) *
              (r[i - 1].substr(0, a - 1).match(/\t/g) || []).length) >
            100 && (c = a - 60 + 3, a = 58);
        for (var u = o; u <= s; u++) {
          u >= 0 && u < r.length &&
            (r[u] = r[u].replace(/\t/g, "    "),
              r[u] = (c > 0 && r[u].length > c ? "…" : "") +
                r[u].substr(c, 98) + (r[u].length > c + 100 - 1 ? "…" : ""));
        }
      ...
      U.prototype = {
        ...
        getRawLength: function (e, t) {
          ...
          e:
          for (; r < this.tokenCount && !((n = this.balance[r]) < e); r++) {
      ...
      function re(e, t) {
        return t = t || 0,
          e.length - t >= 2 && 45 === e.charCodeAt(t) &&
          45 === e.charCodeAt(t + 1);
      }
      function ie(e, t) {
        if (
          t = t || 0,
            e.length - t >= 3 && 45 === e.charCodeAt(t) &&
            45 !== e.charCodeAt(t + 1)
        ) {
          var n = e.indexOf("-", t + 2);
      ...
      function Re(e, t, n, r) {
        ...
        for (; t < e.value.length; t++) {
          if (!ze(e.value.charCodeAt(t))) return 0;
        }
        return r + 1;
      }
      function Me(e, t, n) {
        ...
        if (e.type !== Oe) {
          ...
          if (
            r = !0, i = Ne(n(++i), i, n), null === (e = n(i)) && e.type !== Oe
          ) {
            return 0;
          }
        }
      ...
      function ot(e, t) {
        return t === e.length - 2 &&
          (92 === e.charCodeAt(t) && Ze(e.charCodeAt(t + 1)));
      }
      function st(e, t, n) {
        if (e && "Range" === e.type) {
          var r = Number(
      ...
      var dt,
        mt = {
          ...
          "custom-property-name": function (e) {
            return null === e || e.type !== et.Ident ||
                45 !== rt(e.value, 0) || 45 !== rt(e.value, 1)
              ? 0
              : 1;
          },
          "hex-color": function (e) {
            ...
            for (var n = 1; n < t; n++) {
              if (!Xe(e.value.charCodeAt(n))) return 0;
            }
            return 1;
          },
      ...
      var bt = ft,
        yt = function (e) {
          for (
            var t = "function" == typeof Uint32Array
                ? new Uint32Array(128)
                : new Array(128),
              n = 0;
            n < 128;
      ...
      function Pt(e) {
        ...
        return e.eat(60),
          t = xt(e),
          40 === e.charCode() && 41 === e.nextCharCode() &&
          (e.pos += 2, t += "()"),
      ...
      function Lt(e) {
        for (var t, n = [], r = {}, i = null, a = e.pos; t = Et(e);) {
          "Spaces" !== t.type && ("Combinator" === t.type
        ...
        return null !== i && "Combinator" === i.type &&
          (e.pos -= a, e.error("Unexpected combinator")),
          {
            type: "Group",
            terms: n,
      ...
      function Dt(e) {
        ...
        return t.pos !== e.length && t.error("Unexpected input"),
          1 === n.terms.length && "Group" === n.terms[0].type &&
          (n = n.terms[0]),
          n;
      }
      ...
      var Nt = function (e, t, n) {
          ...
          if (
            "function" == typeof t
              ? r = t
              : t && (r = It(t.enter), i = It(t.leave)), r === Bt && i === Bt
          ) {
            throw new Error(
      ...
      function Ut(e) {
        return "Keyword" === e.type || "AtKeyword" === e.type ||
          "Function" === e.type || "Type" === e.type && Yt(e.name);
      }
      function Ht(e) {
        ...
        switch (e.type) {
                ...
                case "|":
                  ...
                  for (a = n.length - 1; a >= 0; a--) {
                    if (
                      ...
                      var s = (Yt(l.name) ? l.name.slice(0, -1) : l.name)
                        .toLowerCase();
                      if (s in o == !1) {
                        o[s] = l;
                        continue;
          ...
          case "String":
            return 3 === e.value.length
              ...
              : {
                type: e.type,
                value: e.value.substr(1, e.value.length - 2).replace(
                  /\\'/g,
                  "'",
                ),
                syntax: e,
      ...
      function nn(e, t) {
        ...
        for (var n = 0; n < e.length; n++) {
          ...
          if (
            r >= 65 && r <= 90 && (r |= 32), r !== t.charCodeAt(n)
          ) {
            return !1;
          }
        }
      ...
      function rn(e) {
        return null === e ||
          (e.type === en.Comma || e.type === en.Function ||
            e.type === en.LeftParenthesis ||
            e.type === en.LeftSquareBracket ||
            e.type === en.LeftCurlyBracket || function (e) {
      ...
      function an(e) {
        return null === e ||
          (e.type === en.RightParenthesis ||
            ...
            e.type === en.RightCurlyBracket || e.type === en.Delim);
      }
      function on(e, t, n) {
        function r() {
          do {
            ...
            case "Enum":
              if (null !== f) {
                if (
                  ...
                  (A = A.replace(/\\[09].*$/, "")), Xt.call(t.map, A)
                ) {
                  t = t.map[A];
                  break;
                }
      ...
      Tn.prototype = {
        ...
        addType_: function (e, t) {
          t &&
            (this.types[e] = this.createDescriptor(t, "Type", e),
              t === mt["-ms-legacy-expression"] &&
              (this.valueCommonSyntax = Sn));
        },
        ...
        getAtruleDescriptor: function (e, t) {
          return this.atrules.hasOwnProperty(e) &&
              this.atrules.declarators && this.atrules[e].declarators[t] ||
            null;
        },
                ...
                (function (o) {
                  if ("Type" === o.type || "Property" === o.type) {
                    var s = "Type" === o.type ? r.types : r.properties,
                      l = "Type" === o.type ? t : n;
                    s.hasOwnProperty(o.name) &&
                        !e(r, o.name, l, s[o.name]) || (a[i] = !0);
                  }
                }),
                this,
              );
          ...
          this.linesAndColumnsComputed || (!function (e, t) {
            for (
              ...
              r[s] = i,
                a[s] = o++,
                10 !== l && 13 !== l && 12 !== l ||
                (13 === l && s + 1 < n && 10 === t.charCodeAt(s + 1) &&
                  (r[++s] = i, a[s] = o),
                  i++,
                  o = 1);
            }
          ...
          var t = {
            ...
            eat: function (e) {
              if (this.scanner.tokenType !== e) {
                ...
                switch (e) {
                  case Hn:
                    this.scanner.tokenType === Vn ||
                      this.scanner.tokenType === Kn
          ...
          return function (e, n) {
            ...
            if (
              Ce(e, t.scanner),
                ...
                t.onParseError = "function" == typeof n.onParseError
                  ? n.onParseError
                  : Fn,
                t.onParseErrorThrow = !1,
                t.parseAtrulePrelude = !("parseAtrulePrelude" in n) ||
                  Boolean(n.parseAtrulePrelude),
                t.parseRulePrelude = !("parseRulePrelude" in n) ||
                  Boolean(n.parseRulePrelude),
                t.parseValue = !("parseValue" in n) ||
                  Boolean(n.parseValue),
                t.parseCustomProperty = "parseCustomProperty" in n &&
                  Boolean(n.parseCustomProperty),
      ...
      ur.prototype._version = 3,
        ...
        ur.prototype.setSourceContent = function (e, t) {
          ...
          (n = nr.relative(this._sourceRoot, n)),
            null != t
        ...
        ur.prototype._validateMapping = function (e, t, n, r) {
          if (
            t && "number" != typeof t.line && "number" != typeof t.column
          ) {
            throw new Error(
          ...
          if (
            (!(e && "line" in e && "column" in e && e.line > 0 &&
              e.column >= 0) || t || n || r) &&
            !(e && "line" in e && "column" in e && t && "line" in t &&
              "column" in t && e.line > 0 && e.column >= 0 && t.line > 0 &&
              t.column >= 0 && n)
          ) {
            throw new Error(
              "Invalid mapping: " +
        ...
        ur.prototype._serializeMappings = function () {
          for (
            ...
            if (e = "", (t = h[p]).generatedLine !== a) {
              ...
              if (
                !nr.compareByGeneratedPositionsInflated(t, h[p - 1])
              ) {
                continue;
              }
              e += ",";
          ...
          var s = wr(n),
            ...
            c = function (e, o) {
              function c(e, t, n) {
                ...
                return r === i ||
                  r !== a &&
                    (!(!d.hasOwnProperty(e.type) ||
                      !d[e.type](e, m, c, u)) || p.call(m, e, t, n) === i);
              }
        ...
        Cr = function e(t) {
          ...
          for (var r in t) {
            ...
            (Array.isArray(i) || i instanceof a
              ? i = i.map(e)
              : i.constructor === Object && (i = e(i))), n[r] = i;
          }
          return n;
        };
      const zr = Object.prototype.hasOwnProperty,
        Ar = {
          ...
          scope: function e(t, n) {
            for (const r in n) {
              zr.call(n, r) &&
                (Pr(t[r]) ? e(t[r], Tr(n[r])) : t[r] = Tr(n[r]));
            }
            return t;
          },
          atrule: ["parse"],
      ...
      function Lr(e, t) {
        return "string" == typeof t && /^\s*\|/.test(t)
          ? "string" == typeof e ? e + t : t.replace(/^\s*\|\s*/, "")
          : t || null;
      }
      function Er(e, t) {
        ...
        var t = $n(e),
          ...
          i = function (e) {
            return {
              fromPlainObject: function (t) {
                return e(t, {
                  enter: function (e) {
                    e.children && e.children instanceof a == !1 &&
              ...
              toPlainObject: function (t) {
                return e(t, {
                  leave: function (e) {
                    e.children && e.children instanceof a &&
          ...
          o = {
            ...
            fork: function (t) {
              var n = Or({}, e);
              return Br(
                "function" == typeof t ? t(n, Object.assign) : Or(n, t),
              );
            },
          };
      ...
      function Kr() {
        for (
          var e = 0, t = 0, n = this.scanner.tokenType;
          n === _r || n === Fr;
        ) {
        ...
        if (n !== qr) {
          if (
            !this.scanner.isDelim(43, e) && !this.scanner.isDelim(45, e)
          ) {
            return null;
          }
        ...
        return e > 0 && this.scanner.skip(e),
          ...
          45 !== n && this.error("Number sign is expected"),
          Hr.call(this, 0 !== t),
      ...
      var Gr = {
          ...
          parse: function () {
            ...
            return null !== t && 43 === t.charCodeAt(0) &&
              (t = t.substr(1)),
        ...
        Jr = Qr.Delim;
      function ei() {
        return this.scanner.tokenIndex > 0 &&
            this.scanner.lookupType(-1) === Xr
          ...
          parse: function () {
            ...
            switch (
              this.eat(ai),
                ...
                this.scanner.skipSC(),
                !1 === this.scanner.eof && this.scanner.tokenType !== si &&
                this.scanner.tokenType !== oi && (this.parseAtrulePrelude
                  ? "AtrulePrelude" ===
                      (r = this.parseWithFallback(
                        this.AtrulePrelude.bind(this, e),
                        ci,
                      )).type && null === r.children.head && (r = null)
      ...
      function Si() {
        ...
        return 61 !== t && 126 !== t && 94 !== t && 36 !== t && 42 !== t &&
          124 !== t &&
          this.error(
      ...
      var Mi = {
        ...
        Ki = {
          ...
          parse: function () {
            return this.scanner.isDelim(46) ||
        ...
        Zi = {
          ...
          parse: function () {
            ...
            return this.eat(Xi),
              ...
              47 === this.scanner.source.charCodeAt(t - 1) && (t -= 2),
              {
                type: "Comment",
                loc: this.getLocation(e, this.scanner.tokenStart),
      ...
      function ca() {
        ...
        return "Raw" !== t.type && !1 === this.scanner.eof &&
          this.scanner.tokenType !== ia &&
          !1 === this.scanner.isDelim(33) &&
          !1 === this.scanner.isBalanceEdge(e) && this.error(),
          t;
      }
      var ua = {
        name: "Declaration",
        ...
        parse: function () {
          ...
          return this.scanner.isDelim(33) &&
            ...
            !1 === this.scanner.eof && this.scanner.tokenType !== ia &&
            !1 === this.scanner.isBalanceEdge(n) && this.error(),
            {
              type: "Declaration",
              loc: this.getLocation(t, this.scanner.tokenStart),
              important: s,
      ...
      function Po() {
        ...
        return "Raw" !== e.type && !1 === this.scanner.eof &&
          this.scanner.tokenType !== zo && this.error(),
          e;
      }
      var To = {
          name: "Rule",
      ...
      var Fo = {
        ...
        Wo = Ce.TYPE.Ident;
      function qo() {
        this.scanner.tokenType !== Wo && !1 === this.scanner.isDelim(42) &&
        this.error("Identifier or asterisk is expected"), this.scanner.next();
      }
      var Yo = {
          name: "TypeSelector",
          structure: { name: String },
      ...
      var ts = {
          ...
          parse: function () {
            var e = this.scanner.tokenStart;
            return Ho(this.scanner.source, e, 117) ||
            ...
            var: function () {
              ...
              if (
                ...
                const t = this.scanner.tokenIndex,
                  n = this.parseCustomProperty ? this.Value(null) : this.Raw(
...
var Atrule = function cleanAtrule(node, item, list) {
  ...
  switch (node.name) {
    ...
    case "import":
      if (
        this.stylesheet === null || !this.stylesheet.firstAtrulesAllowed
      ) {
        list.remove(item);
        return;
      }
...
var font = function compressFont(node) {
  ...
  list.eachRight(function (node, item) {
    if (node.type === "Identifier") {
      if (node.name === "bold") {
        ...
        if (
          prev && prev.data.type === "Operator" && prev.data.value === "/"
        ) {
          this.remove(prev);
        }
  ...
  list.each(function (node, item) {
    if (node.type === "WhiteSpace") {
      if (
        !item.prev || !item.next || item.next.data.type === "WhiteSpace"
      ) {
        this.remove(item);
      }
    }
...
var Dimension = function compressDimension(node, item) {
  ...
  if (
    ...
    if (
      this.function && MATH_FUNCTIONS.hasOwnProperty(this.function.name)
    ) {
      return;
    }
...
var Percentage = function compressPercentage(node, item) {
  ...
  if (
    ...
    if (
      !lexer.matchDeclaration(this.declaration).isType(item.data, "length")
    ) {
...
var Url = function (node) {
  ...
  if (SAFE_URL.test(url)) {
    ...
    node.value.value = url.indexOf('"') === -1
      ? '"' + url + '"'
      : quote + url + quote;
  }
};
...
function compareDeclarations(declarations1, declarations2) {
  ...
  for (var cursor = declarations2.head; cursor; cursor = cursor.next) {
    ...
    if (declarations2hash[data.id]) {
      ...
      if (
        !hasOwnProperty$3.call(fingerprints, data.fingerprint) ||
        (!fingerprints[data.fingerprint] && data.important)
      ) {
  ...
  function attemptToAdd() {
    ...
    if (side) {
      ...
      for (var key in sides) {
        if (
          sides[key] !== null && sides[key].special !== values[0].special
        ) {
          return false;
        }
      }
...
var _4RestructShorthand = function restructBlock(ast, indexer) {
  ...
  walk$7(ast, {
    ...
    enter: function (node) {
      ...
      var ruleId = (node.pseudoSignature || "") + "|" +
      ...
      ruleMap.lastShortSelector = processRule$2.call(
        this,
        node,
        shorts,
        shortDeclarations,
...
function processRule$5(node, item, list) {
  ...
  list.prevUntil(item.prev, function (prev, prevItem) {
    ...
    // try to join by selectors
    if (
      allowMergeUp && utils$1.isEqualSelectors(prevSelectors, selectors)
    ) {
    ...
    // try to join by properties
    var diff = utils$1.compareDeclarations(
      block.children,
      prevBlock.children,
    );
...
function getCommentsOption(options) {
  ...
  if (typeof comments === "boolean") {
    ...
    comments !== "exclamation" && comments !== "first-exclamation"
  ) {
    comments = false;
  }
...
function createDefaultLogger(level) {
  ...
  return function logger(title, ast) {
    ...
    if (ast) {
      line = "[" + ((Date.now() - lastDebug) / 1000).toFixed(3) + "s] " +
        line;
    }
